...
class ImpactAnalysis(Base):
    ...
    affected_source_field_ids_json: Mapped[list] = mapped_column(MutableList.as_mutable(JSON), default=list)
    ...
    affected_semantic_binding_ids_json: Mapped[list] = mapped_column(MutableList.as_mutable(JSON), default=list)
    affected_semantic_concept_ids_json: Mapped[list] = mapped_column(MutableList.as_mutable(JSON), default=list)
    affected_semantic_version_ids_json: Mapped[list] = mapped_column(MutableList.as_mutable(JSON), default=list)
    affected_regulatory_rule_ids_json: Mapped[list] = mapped_column(MutableList.as_mutable(JSON), default=list)
    affected_regulatory_knowledge_item_ids_json: Mapped[list] = mapped_column(MutableList.as_mutable(JSON), default=list)
    affected_requirement_ids_json: Mapped[list] = mapped_column(MutableList.as_mutable(JSON), default=list)
    affected_review_task_ids_json: Mapped[list] = mapped_column(MutableList.as_mutable(JSON), default=list)
    summary_json: Mapped[dict] = mapped_column(MutableDict.as_mutable(JSON), default=dict)
