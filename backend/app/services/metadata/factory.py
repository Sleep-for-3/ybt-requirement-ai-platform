from app.services.metadata.generic_adapter import SqlAlchemyMetadataAdapter, UnsupportedMetadataAdapter
...
def create_metadata_adapter(datasource):
    ...
    if kind in {"oracle", "sqlserver", "mssql", "db2"}: return SqlAlchemyMetadataAdapter(datasource)
