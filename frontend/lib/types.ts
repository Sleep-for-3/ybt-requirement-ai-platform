...
export type ReadableSemanticAssetReference = { entity_type:string;restricted:false;entity_id:number;display_name:string;display_code?:string|null;href?:string|null };
export type RestrictedSemanticAssetReference = { entity_type:string;restricted:true };
export type SemanticAssetReference = ReadableSemanticAssetReference | RestrictedSemanticAssetReference;
export type SemanticCatalogItem = { id:number;project_id:number;concept_type:string;concept_code:string;concept_name:string;status:SemanticLifecycleStatus;business_domain?:string|null;owner_department?:string|null;effective_version?:SemanticCatalogEffectiveVersion|null;related_asset_count:number;has_relation:boolean;review:SemanticCatalogReviewSummary;updated_at:string };
