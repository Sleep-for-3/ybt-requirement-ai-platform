...
export default function Page() {
  ...
  useEffect(() => {
    apiGet<Institution[]>("/admin/institutions").then(setInstitutions).catch(() => setMsg("无权读取机构"));
  }, []);
  ...
  return (
    <main>
      <WorkspaceHeader title="用户管理" meta="本地账号与机构成员角色" />
      <div className="mx-auto max-w-2xl p-4 lg:p-6">
        <form className="panel" onSubmit={create}>
          <div className="panel-header">
            <h2 className="text-[15px] font-semibold text-ink">新建用户</h2>
          </div>
